...
function Periodo(){
    return(
        <body>
        <header>
            <h1>Período<i class="bi bi-people-fill"></i></h1>
        </header>


        <div className="containerr">
            <button class="btn-form-cad" type="button"   id="cadastrarPeriodo">CADASTRAR</button>

            <table id="tablePeriodo" className="tabela">
                <thead>
                    <tr>
                        <th>N° do Período:</th>
                        <th>Sementre/Ano do Período:</th>
                        <th>Data Início:</th>
                        <th>Data Fim:</th>
                        <th>Turno:</th>
                        <th>Curso:</th>
